// First to pull the required items and things
    ...
    startGame: function () {
        ...
        inquirer.prompt([{
            ...
            if (answer.play) {
                ...
                console.log("Why run this at all?");
            }
        })
    },
    newGame: function () {
        if (this.guessesRemaining === 10) {
            ...
            var randNum = Math.floor(Math.random() * hangman.wordBank.length);
            this.currentWord = new Word(hangman.wordBank[randNum]);
            this.currentWord.getLets();
            //displays current word as blanks.
            console.log(hangman.currentWord.wordRender());
